        ...
        <div class="card bg-light-secondary shadow-none position-relative overflow-hidden">
            <div class="card-body px-4 py-3">
                <div class="row align-items-center">
                    <div class="col-9">
                        <h4 class="fw-semibold mb-8">Tambah Data Pengumuman</h4>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">Tambah Data Pengumuman</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-3">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" action="{{ route('admin-panel.announcement.store') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group mb-3">
								...
								<textarea name="content" id="" cols="30" rows="50" class="form-control">{{ old('content') }}</textarea>
                            </div>
                            <div class="form-group mb-3">
                                ...
                                <select name="status" id="status" class="form-select">
                                    ...
                                    <option value="drafted" {{ old('status') == 'drafted' ? 'selected' : '' }}>Diarsipkan</option>
                                </select>
                            </div>
